        ...
        $html = '<section id="gtco-single-content" class="bg-white">
                        <div class="container">
                                ...
                                <div id="main-container">
                                        <div class="card" style="width: 18rem;">
                                                ...
                                                <div class="card-body">
                                                        ...
                                                        <br>
                                                        <h5 class="card-title">That\'s my second explanation:</h5>
                                                        <p class="card-body">'.nl2br($jsonobj['explanation']).'</p>
                                                </div>
                                        </div>
                                </div>
                                <div class="title-wrap">
                                ...
                                <div class="col-md-11 offset-md-1 contact-form-holder mt-4">
                                        <form id="recForm" method="post" action="../php/quest_schema.php">

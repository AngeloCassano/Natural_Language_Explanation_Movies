...
# Funzione che prende in input il grafo costruito, le proprietà in comune e i due dizionari di film piaciuti e
# raccomandati  ed effettua il ranking delle proprietà in comune in ordine di
...
def ranking_proprieta(G, proprietà_comuni, item_piaciuti, item_raccom):
    ...
    print("Le proprietà sono state rankate e ordinate con successo!\n")

    return sorted_prop


# Funzione che prende in input le proprietà rankate e ordinate per punteggio e il numero di proprieta da considerare
...
# Funzione che stampa in ordine di punteggio le proprietà
